...
export default function CalenderTab() {
    ...
    return (
        <View style={{backgroundColor: "#009ddc"}}>
            <ScrollView style={{marginTop: 35, backgroundColor: "#009ddc"}} refreshControl={
                <RefreshControl refreshing={refreshing} onRefresh={onRefresh}/>
            }>
                <Text style={{backgroundColor: "#009ddc"}}>{HolidayData.title}</Text>
                <Picker style={{backgroundColor: "#009ddc"}} selectedValue={SchoolYear}
                ...
                {Available ? (
                    HolidayData.vacations.map((d, i) => (
                        <ListItem key={i} topDivider style={{backgroundColor: "#009ddc"}}>
                            <ListItem.Content style={{backgroundColor: "#009ddc"}}>
